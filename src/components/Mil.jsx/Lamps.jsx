          ...
          <div className="form-group">
            ...
            <Select
              ...
              value={{
                ...
                label: inputs.voltage === 'custom'
                  ? 'Custom Voltage'
                  : `${inputs.voltage}V (λb = ${getBaseRate(inputs.voltage)})`
              }}
          ...
          <div className="form-group">
            ...
            <Select
              ...
              value={{
                ...
                label: inputs.application === 'AC'
                  ? 'Alternating Current (πA = 1.0)'
                  : 'Direct Current (πA = 3.3)'
              }}
              onChange={(selectedOption) => {
                setInputs(prev => ({
                  ...prev,
          ...
          <div className="form-group">
            ...
            <Select
              ...
              value={{
                ...
                label: `${getUtilizationLabel(inputs.utilization)} (πT = ${getUtilizationFactor(inputs.utilization)})`
              }}
              onChange={(selectedOption) => {
                setInputs(prev => ({
                  ...prev,
