                ...
                {result && (
                  <>
                    <div className="Predicted-FailureRate">
                     ...
                     {/* {totalSysFailureRate.push(result?.value * component?.quantity)} */}
                  ...
                  <div className="Predicted-FailureRate">
                    ...
                    <span className="ms-2">
                      ...
                      {console.log("Sawdevice", currentComponent?.calculatedFailureRate * component?.quantity)}
                                             {/* {totalSysFailureRate.push(currentComponent?.calculatedFailureRate * component?.quantity)} */}
                    </span>
                    <br/>
                    <strong>λ<sub>c</sub> * N<sub>c</sub>:</strong>
                    <span className="ms-2 ">
              ...
              <>
                <div>
                  ...
                  <p className="mb-1">
                    ...
                    {console.log("CalculateGate123..", results?.value * component?.quantity)}
                  </p>
                </div>
          ...
          <>
            ...
            {result2 && (
              <>
                ...
                {/* {totalSysFailureRate.push(result2?.value * component?.quantity)} */}
              ...
              <>
                ...
                <div className="Predicted-FailureRate">
                  ...
                  <span className="ms-2">{result3?.value * component?.quantity} failures/10<sup>6</sup> hours</span>
                    {/* {totalSysFailureRate.push(result3?.value * component?.quantity)} */}
