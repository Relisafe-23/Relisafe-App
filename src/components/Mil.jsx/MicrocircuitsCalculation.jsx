        ...
        {currentComponent.type === "Microcircuits,Memories" && (
          <>
            <Row >
              ...
              {/* <Col md={4}>
                <div className="form-group">
                  <label>Memory Size (Bits) for (B<sub>1</sub>):</label>
                  <Select
                    style={customStyles}
                    name="memorySize"
                    placeholder="Select Memory Size"
                    value={currentComponent.memorySizeOption}
                    onChange={(selectedOption) => {
                      const updatedComponent = {
                        ...currentComponent,
                        memorySizeOption: selectedOption,
                        memorySize: selectedOption.value,
                        // Reset dependent fields when memory size changes
                        memoryTech: null,
                        memoryTechOption: null,
                        B1: null,
                    
                        techTemperature: null
                      };
                      setCurrentComponent(updatedComponent);
                      updateComponentInList(updatedComponent);
                    }}
